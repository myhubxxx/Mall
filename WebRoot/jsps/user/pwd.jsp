...
<html>
  ...
  <body>
	...
	<div class="div1">
		<form action="<c:url value='/changePass.action'/>" method="post" target="_top">
		...
		<table>
			...
			<tr>
				...
				<td><input class="input" type="password" name="user.newPassword" id="newpass" value="${user.newPassword }""/></td>
				<td><label id="newpassError" class="error"></label></td>
			</tr>
			<tr>
				<td align="right">确认密码:</td>
				<td><input class="input" type="password" name="user.surePassword" id="reloginpass" value="${user.surePassword }""/></td>
				<td><label id="reloginpassError" class="error"></label></td>
			</tr>
			<tr>
				<td align="right"></td>
				<td>
				  <img id="vCode" src="<c:url value='/captcha.action'/>" border="1"/>
			...
			<tr>
				...
				<td>
				  <input class="input" type="text" name="user.verifyCode" id="verifyCode" value="${user.verifyCode }""/>
				</td>
