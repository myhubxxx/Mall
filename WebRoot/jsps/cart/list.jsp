...
<c:forEach items="${shopCarList }" var="cartItem">
	<tr align="center">
		...
		<td>
			<a class="jian" id="${cartItem.sid }Jian"></a><input class="quantity" readonly="readonly" id="${cartItem.sid }Quantity" type="text" value="${cartItem.number }"/><a class="jia" id="${cartItem.sid }Jia"></a>
		</td>
		<td width="100px">
