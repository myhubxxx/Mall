...
<script type="text/javascript">
	function _go() {
		...
		location = "<c:url value='/listByCategoryAdmin.action?goodsname=${goodsname}&categoryId=${categoryId}&pageNow='/>" + pc;
	}
</script>
...
<c:choose>
	...
	<c:otherwise><a href="<c:url value='/listByCategoryAdmin.action?goodsname=${goodsname}&categoryId=${categoryId}&pageNow='/>${pb.currentPage-1}" class="aBtn bold">上一页</a></c:otherwise>
</c:choose>
...
<%--  <c:choose>
 ...
 <c:forEach begin="${page.start }" end="${page.end }" var="i">
   <c:choose>
   	  ...
   	  <c:otherwise>
   	    <a href="<c:url value='/listByCategoryAdmin.action?goodsname=${goodsname}&categoryId=${categoryId}&pageNow='/>${i}" class="aBtn">${i }</a>
   	  </c:otherwise>
   </c:choose>
...
<c:choose>
	...
	<c:otherwise><a href="<c:url value='/listByCategoryAdmin.action?goodsname=${goodsname}&categoryId=${categoryId}&pageNow='/>${pb.currentPage+1}" class="aBtn bold">下一页</a></c:otherwise>
</c:choose>
